...
export default function MainPage() {
    ...
    const socialLinks = [
        { name: "Instagram", icon: instagram, link: "https://instagram.com/imh4nny", color: "bg-pink-500 bg-opacity-80" },
        { name: "TikTok", icon: tiktok, link: "https://tiktok.com/@imh4nny", color: "bg-black" },
        { name: "Kick", icon: kick, link: "https://kick.com/imh4nny", color: "bg-green-500 bg-opacity-80" },
        { name: "YouTube", icon: youtube, link: "https://youtube.com/@imh4nny", color: "bg-red-500 bg-opacity-80" },
    ];
                ...
                >
                    ...
                    <h2 className="text-3xl font-bold text-gray-900">
                        <motion.span 
                            ...
                            style={{ animationDelay: "2s", animationIterationCount: "infinite" }}
                        >
                            💖
                        </motion.span> 
                        {" Apoya el Stream "} 
                    ...
                    <p className="text-lg mt-2 text-gray-800">
                        Cada donación me ayuda a seguir creando contenido increíble para ustedes. ¡Gracias por el apoyo! 🎉
                    </p>
